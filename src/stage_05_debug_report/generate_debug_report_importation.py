# -*- coding: utf-8 -*-
"""
Stage 05 - IMPORTATION - Detailed debug report from Stage 02 + Stage 03

Inputs:
- Stage 02: data/output/stage_02_fields/importation/*_fields.json
- Stage 03: data/output/stage_03_compare/importation/_stage03_comparison.json

Outputs:
- data/output/stage_05_debug_report/importation/_stage05_debug_report.json
- data/output/stage_05_debug_report/importation/_stage05_debug_report.md
- data/output/stage_05_debug_report/importation/_stage05_debug_report.html
"""
...
def build_markdown(report: dict) -> str:
    ...
    lines.append("# Stage 05 Debug Report - Importation")
    lines.append("")
...
<head>
  ...
  <title>Stage 05 Debug Report - Importation</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <h1>Stage 05 Debug Report - Importation</h1>
...
def main() -> None:
    ...
    ap.add_argument("--stage02", required=True, help="Stage 02 folder (importation)")
